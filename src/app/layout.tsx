...
export const metadata: Metadata = {
  title: "The Grand Aurora - Luxury Hotel & Resort Experience",
  description: "Experience unparalleled luxury at The Grand Aurora. World-class amenities, exceptional service, and elegant accommodations in paradise.",
  keywords: "luxury hotel, 5-star resort, premium accommodations, spa, fine dining, ocean view suites",
  metadataBase: new URL('https://thegrandaurora.com'),
  alternates: {
    canonical: 'https://thegrandaurora.com'
  },
  openGraph: {
    title: "The Grand Aurora - Luxury Hotel & Resort Experience",
    description: "Experience unparalleled luxury at The Grand Aurora. World-class amenities, exceptional service, and elegant accommodations.",
    siteName: "The Grand Aurora",
    images: [{
      url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "The Grand Aurora luxury hotel lobby"
    }],
    type: "website"
  },
  twitter: {
